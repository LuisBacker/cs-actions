...
public class NutanixUpdateVMInputs {
    ...
    public static class NutanixUpdateVMInputsBuilder {
        ...
        @NotNull
        public NutanixUpdateVMInputsBuilder hypervisorType(@NotNull final String hypervisorType) {
            this.hypervisorType = hypervisorType;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder flashModeEnabled(@NotNull final String flashModeEnabled) {
            this.flashModeEnabled = flashModeEnabled;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder isSCSIPassThrough(@NotNull final String isSCSIPassThrough) {
            this.isSCSIPassThrough = isSCSIPassThrough;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder isThinProvisioned(@NotNull final String isThinProvisioned) {
            this.isThinProvisioned = isThinProvisioned;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder isCDROM(@NotNull final String isCDROM) {
            this.isCDROM = isCDROM;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder isEmpty(@NotNull final String isEmpty) {
            this.isEmpty = isEmpty;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder deviceBus(@NotNull final String deviceBus) {
            this.deviceBus = deviceBus;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder diskLabel(@NotNull final String diskLabel) {
            this.diskLabel = diskLabel;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder deviceIndex(@NotNull final String deviceIndex) {
            this.deviceIndex = deviceIndex;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder ndfsFilepath(@NotNull final String ndfsFilepath) {
            this.ndfsFilepath = ndfsFilepath;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder sourceVMDiskUUID(@NotNull final String sourceVMDiskUUID) {
            this.sourceVMDiskUUID = sourceVMDiskUUID;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder vmDiskMinimumSize(@NotNull final String vmDiskMinimumSize) {
            this.vmDiskMinimumSize = vmDiskMinimumSize;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder externalDiskUrl(@NotNull final String externalDiskUrl) {
            this.externalDiskUrl = externalDiskUrl;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder externalDiskSize(@NotNull final String externalDiskSize) {
            this.externalDiskSize = externalDiskSize;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder storageContainerUUID(@NotNull final String storageContainerUUID) {
            this.storageContainerUUID = storageContainerUUID;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder vmDiskSize(@NotNull final String vmDiskSize) {
            this.vmDiskSize = vmDiskSize;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder networkUUID(@NotNull final String networkUUID) {
            this.networkUUID = networkUUID;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder requestedIPAddress(@NotNull final String requestedIPAddress) {
            this.requestedIPAddress = requestedIPAddress;
            return this;
        }

        @NotNull
        public NutanixUpdateVMInputsBuilder isConnected(@NotNull final String isConnected) {
            this.isConnected = isConnected;
            return this;
        }
